...
private String strRecorrido = "";
    ...
    private void btnPreordenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreordenActionPerformed
        try{
            ...
            txtConsola.setText(txtConsola.getText() + getStrRecorrido().substring(0, getStrRecorrido().length() - 3) + "." + System.lineSeparator());
        }catch(Exception ex)
        {
...
public void RecorridoPreorden(DefaultMutableTreeNode nodoRaiz)
    {
        ...
        {
            setStrRecorrido(getStrRecorrido() + nodoRaiz.getUserObject().toString().split("-")[1].trim() + " - ");
...
public void RecorridoPostorden(DefaultMutableTreeNode nodoRaiz)
    ...
    /**
     * @return the strRecorrido
     */
    public String getStrRecorrido() {
        return strRecorrido;
    }

    /**
     * @param strRecorrido the strRecorrido to set
     */
    public void setStrRecorrido(String strRecorrido) {
        this.strRecorrido = strRecorrido;
    }
}
